...
describe('ScoreEngine', () => {
  const createBaseRound = (): Round => ({
    ...
    status: 'UNDER',
    players: [
      { playerId: 'p1', name: 'P1', call: 4,  actualTricks: 4, result: 'WIN', isCaller: true, isWith: false, declaration: 'NONE', riskLevelId: 'normal', calculatedScore: 0, manualScoreOverride: null, manualLoseOverride: null, finalScore: 0, scoreBreakdown: [] },
      { playerId: 'p2', name: 'P2', call: 4,  actualTricks: 4, result: 'WIN', isCaller: false, isWith: false, declaration: 'NONE', riskLevelId: 'normal', calculatedScore: 0, manualScoreOverride: null, manualLoseOverride: null, finalScore: 0, scoreBreakdown: [] },
      { playerId: 'p3', name: 'P3', call: 4,  actualTricks: 3, result: 'LOSS', isCaller: false, isWith: false, declaration: 'NONE', riskLevelId: 'normal', calculatedScore: 0, manualScoreOverride: null, manualLoseOverride: null, finalScore: 0, scoreBreakdown: [] },
      { playerId: 'p4', name: 'P4', call: 4,  actualTricks: 2, result: 'LOSS', isCaller: false, isWith: false, declaration: 'NONE', riskLevelId: 'normal', calculatedScore: 0, manualScoreOverride: null, manualLoseOverride: null, finalScore: 0, scoreBreakdown: [] },
    ],
